...
{
    real gra, xa, ra43, ra13, ua, ua2, gxa2;
    real grb, xb, rb43, rb13, ub, ub2, gxb2;
    real faR, faZ;
    real fbR, fbZ;
...
{
    real ra, xa, ra43, ra13, ua, ua2, gxa2;
    real rb, xb, rb43, rb13, ub, ub2, gxb2;
...
{
    real ra, xa, xa2, ra43, ra13, ua, ua2, gxa2;
    real rb, xb, xb2, rb43, rb13, ub, ub2, gxb2;
    real faR, faZ, faZZ, faRZ, faRR;
    real fbR, fbZ, fbZZ, fbRZ, fbRR;
