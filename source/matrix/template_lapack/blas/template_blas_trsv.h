...
#ifndef TEMPLATE_BLAS_TRSV_HEADER
#define TEMPLATE_BLAS_TRSV_HEADER


template<class Treal>
int template_blas_trsv(const char *uplo, const char *trans, const char *diag, const integer *n, 
