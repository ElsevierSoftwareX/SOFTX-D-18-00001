...
#ifndef TEMPLATE_LAPACK_LAEBZ_HEADER
#define TEMPLATE_LAPACK_LAEBZ_HEADER


template<class Treal>
int template_lapack_laebz(const integer *ijob, const integer *nitmax, const integer *n, 
	const integer *mmax, const integer *minp, const integer *nbmin, const Treal *abstol, 
	const Treal *reltol, const Treal *pivmin, const Treal *d__, const Treal *
	e, const Treal *e2, integer *nval, Treal *ab, Treal *c__, 
	integer *mout, integer *nab, Treal *work, integer *iwork, 
	integer *info)
{
...
/*                 Insure that N(w) is monotone   
   ...
   Computing MAX */
		    ...
		    i__3 = nab_ref(ji, 2), i__4 = maxMACRO(i__5,i__6);
		    iwork[ji] = minMACRO(i__3,i__4);
...
/*                 IJOB=2: Choose all intervals containing eigenvalues.   
   ...
   Computing MAX */
		    i__5 = nab_ref(ji, 1);
		    i__3 = nab_ref(ji, 2), i__4 = maxMACRO(i__5,itmp1);
		    itmp1 = minMACRO(i__3,i__4);
...
/*        Check for convergence */
	...
	i__2 = kl;
	for (ji = kf; ji <= i__2; ++ji) {
	    tmp1 = (d__1 = ab_ref(ji, 2) - ab_ref(ji, 1), absMACRO(d__1));
/* Computing MAX */
	    d__3 = (d__1 = ab_ref(ji, 2), absMACRO(d__1)), d__4 = (d__2 = ab_ref(
		    ji, 1), absMACRO(d__2));
	    tmp2 = maxMACRO(d__3,d__4);
/* Computing MAX */
	    d__1 = maxMACRO(*abstol,*pivmin), d__2 = *reltol * tmp2;
	    if (tmp1 < maxMACRO(d__1,d__2) || nab_ref(ji, 1) >= nab_ref(ji, 2)) {
